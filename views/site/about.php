    ...
    <div class="sidebar" data-color="green" data-background-color="white">
      ...
      <div class="logo">
        <a href="dashboard.html" class="simple-text logo-mini">
          <img width="28" height="28" src="https://pbs.twimg.com/profile_images/776831003235119105/FWj1RESO_400x400.jpg"
            alt="logo" class="jss22">
        </a>
      ...
      <!---------- START USER CONFIGURATION SIDEBAR ---------->
      <div class="sidebar-wrapper">
        <div class="user">
          <div class="photo">
            <img src="assets/img/faces/neutral_avatar.svg" />
          </div>
          <div class="user-info">
        ...
        <ul class="nav">
          ...
          <li class="nav-item ">
            ...
            <div class="collapse" id="pagesExamples">
              <ul class="nav">
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="error_inside.html">
                      <span class="sidebar-mini"> IE </span>
                      <span class="sidebar-normal"> Inside Error Page </span>
                    </a>
                  </li>
              </ul>
            </div>
          ...
          <li class="nav-item ">
            ...
            <div class="collapse" id="formsExamples">
              <ul class="nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="ex_wizard.html">
          ...
          <li class="nav-item ">
            ...
            <div class="collapse" id="tablesExamples">
              <ul class="nav">
                <li class="nav-item ">
                  <a class="nav-link" href="ex_table.html">
                    <span class="sidebar-mini"> TB </span>
                    <span class="sidebar-normal"> Example Table </span>
                  </a>
                </li>
              </ul>
            </div>
              ...
              <ul class="nav">
                <li class="nav-item ">
                  <a class="nav-link" data-toggle="collapse" href="#componentsCollapse">
                    <span class="sidebar-mini"> MLC </span>
                    <span class="sidebar-normal"> Multi Level Collapses
                      <b class="caret"></b>
                    </span>
                  </a>
                    ...
                    <ul class="nav">
                      <li class="nav-item ">
                        <a class="nav-link" href="#0">
                          ...
                          <span class="sidebar-normal"> Mock 1 </span>
                        </a>
                      </li>
                    </ul>
                  </div>
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="#">
                    ...
                    <span class="sidebar-normal"> Mock 2 </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="blank_page.html">
                    <span class="sidebar-mini"> BP </span>
                    <span class="sidebar-normal"> Blank Page </span>
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                  ...
                  <div class="card-footer">
                    <div class="stats">
                      <i class="material-icons">local_offer</i>Analytics
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                  <div class="card-header card-header-info card-header-icon">
                    ...
                    <p class="card-category">Tickets followed</p>
