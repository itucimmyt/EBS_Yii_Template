            ...
            <div class="logo">
                <a href="dashboard.html" class="simple-text logo-mini">
                    <img width="28" height="28"
                        src="https://pbs.twimg.com/profile_images/776831003235119105/FWj1RESO_400x400.jpg" alt="logo"
                        class="jss22">
                </a>
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    ...
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="#pablo">Error inside</a>
                    </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="wrapper wrapper-full-page">
                            <!-- <div class="page-header error-page header-filter"
                                 style="background-image: url('assets/img/potato/potato-fields.jpg')"> -->
                            <div class="page-header error-page header-filter"
                                style="background-image: url('assets/img/potato/errorPotatoJoke.jpg')">
